// https://thejsway.net/chapter14/#counting-elements
...
// сделать то же самое без querySelectorAll, используя только DOM-свойства (children и рекурсию),
// как для тренировки JS Core
